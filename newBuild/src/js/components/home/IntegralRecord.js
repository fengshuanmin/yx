    ...
    render() {
        return (
            <div className="IntegralRecord">
                {/*<div className="integralTitle">积分记录</div>*/}
                <div className="integralContext">
                    <div className="contextLeft">
                        {this.state.leftSlide}
                    </div>
                    <div className="contextRight">
                        {this.state.rightSlide}
                    </div>
                </div>
                <div className="checkMore" onClick={this.loadMore}><span>查看更多积分记录</span></div>
            </div>
        )
    }
}