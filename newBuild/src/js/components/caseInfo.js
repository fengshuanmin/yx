    ...
    newSubmit(){
       ...
       // this.showEWM("/home/weblogic/lexiu_path/app//twoCode/TMXC2017072000991DSTMXC2017072000992TMXC2017072000990TMXC0032017090600007.png")
        ...
        var arr={
            ...
            // pushDesc:{name:'备注',type:'pushDesc'},
            ...
            <div className="caseInfo Rcontainer">
                <div className="caseBox">
                    ...
                    <ul className="radioType">
                        ...
                        <li>
                            <span>案件车辆</span>
                            <span><input type="radio" defaultChecked value="0201" name="taskType" id="taskType" onChange={this.changeModel.bind(this,'type1')}/><label style={{width:'auto',display:'inline-block'}} htmlFor="taskType">标的</label></span>
                            <span><input type="radio" value="0202" name="taskType" id="taskType1" onChange={this.changeModel.bind(this,'type1')}/><label style={{width:'auto',display:'inline-block'}} htmlFor="taskType1">三者车</label></span>
                        </li>
                        <li>
                            <span>车辆级别</span>
                            <span><input type="radio" defaultChecked value="com" name="xlcRepairLevel" id="xlcRepairLevel" onChange={this.changeModel.bind(this,'type1')}/><label style={{width:'auto',display:'inline-block'}} htmlFor="xlcRepairLevel">常规</label></span>
                            <span><input type="radio" value="adv" name="xlcRepairLevel" id="xlcRepairLevel1" onChange={this.changeModel.bind(this,'type1')} /><label style={{width:'auto',display:'inline-block'}} htmlFor="xlcRepairLevel1">高端</label></span>
                        </li>
                        <li>
                            <span>推估损方式</span>
                            <span><input type="radio" defaultChecked value="2" name="lossWay" id="lossWay1" onChange={this.changeModel.bind(this,'type1')}/><label style={{width:'auto',display:'inline-block'}} htmlFor="lossWay1">到店辅助</label></span>
                            <span><input type="radio" value="1" name="lossWay" id="lossWay" onChange={this.changeModel.bind(this,'type1')} /><label style={{width:'auto',display:'inline-block'}} htmlFor="lossWay">全权委托</label></span>
                        </li>
                        <li>
                            <span></span>
                            <span><input type="radio" value="3" name="lossWay" id="KS" onChange={this.changeModel.bind(this,'type1')} /><label style={{width:'auto',display:'inline-block'}} htmlFor="KS">现场快速定损</label></span>
                        </li>
                    </ul>
                </div>
                 <div className="caseBox">
                     ...
                     <ul>
                         ...
                         <li><input type="text" placeholder="备注" name="pushDesc"  onBlur={this.toUppe.bind(this,'type1')}/></li>
                         <li>
