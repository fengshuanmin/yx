        ...
        return(
            <div>
                {this.state.url!=''?<div style={{width:'6.5rem',borderRadius:'0.2rem 0.2rem 0 0',height:'8rem',margin:'0.4rem auto'}}>
                    ...
                    {this.state.canvas}
                    <div style={{background:'#fff',width:'100%',height:'8rem',textAlign:'center',boxShadow:' 0 0.1rem 0.2rem #ccc'}}>
                        ...
                        <div style={{color:'#666',fontSize:'0.28rem',padding:'0.1rem'}}>
                        ...
                        <div style={{color:'#666',fontSize:'0.28rem'}}>超时需重新生成</div>
                    </div>
