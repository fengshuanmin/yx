    ...
    constructor(props) {
        ...
        this.dataReform=(datas,type,im)=>{
            ...
            if(datas && datas.code==0) {
                ...
                var datArr = {
                    am: {datArr: ['appointLibraryName','carNumber', 'cardTypeName','partNames'], path: '/dingdan/dingdan'}
                }
                var arrname = {appointLibraryName:'', carNumber: '车牌', cardTypeName: '车型', partNames: '配件'}
                for (var i in dat) {
                    dat[i].type = im;
