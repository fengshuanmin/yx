...
export default class List extends React.Component {
    constructor(props) {
        ...
        this.addinquiry=()=>{
            ...
            this.props.history.pushState(null,'inquiry/addInquiry1')
        }
    ...
    render(){
        ...
        return(
            ...
            <div className="recoverList">
                ...
                <DSYButton ButtonFrom="DSYs" T={this} on={'inquiry'} {...this.props}/>
