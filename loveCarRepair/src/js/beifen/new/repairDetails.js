        ...
        return(
            <div className="repairDetails Rcontainer">
					...
					<ul>
						<li>
							<div className="ordTitleBox">
								<div><span className="dian"></span></div>
								<div className="orderTitle">
									<h5>您的车辆信息已经发送俱乐部</h5>
									<p><span>2017-07-21</span><span>19:55:55</span></p>
								</div>
							</div>
							<div>
								<ul>
				...
				<div className="order">
					<h4>维修进度</h4>
					<ul className="recordUl">
						<li><span>报案号:</span><span>{response.ReportNo}</span></li>
						<li><span>维修金额:</span><span>{response.RepairMoneny}</span></li>
						<li><span>修理厂名称:</span><span>{response.XlcName}</span></li>
						<li><span>修理厂地址:</span><span>{response.XlcAddr}</span></li>
						<li><span>维修进度:</span><span>{this.state.taskState[response.TaskState-1]}</span></li>
					</ul>
				</div>
				<div className="order speedOfProgress">
					<ul>
						...
						<li>
							<div><span className="dian old"></span></div>
							<div>
								<h5>您的车辆信息已经发送俱乐部</h5>
								<p><span>2017-07-21</span><span>19:55:55</span></p>
							</div>
