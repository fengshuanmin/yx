...
//            jsonp: "callback",
    ...
    componentDidUpdate(){
        const recordList=this.state.recordList,$recordListLi= $(".recordList li"),this_=this;
            ...
            recordArr.push(
                <li key={i}>
                    <table>
                        ...
                        <tr>
                            <td>保险公司：</td>
                            <td><span>{item.inscompanyname}</span></td>
                        </tr>
                        <tr>
                            <td>报案号：</td>
                            <td><span>{item.reportno}</span></td>
                        </tr>
                        <tr>
                            <td>送修时间：</td>
                            <td><span>{item.pushtime}</span></td>
                        </tr>
                        <tr>
                            <td>状态：</td>
                            <td><span>{item.stateStr}</span></td>
                        </tr>
                        </tbody>
                    </table>
                    <span className="checkDetails">查看详情 <em className="iconfont">&#xe608;</em></span>
                </li>
            )
        }
