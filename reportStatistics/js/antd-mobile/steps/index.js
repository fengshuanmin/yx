...
var Steps = function (_React$Component) {
    ...
    Steps.prototype.render = function render() {
        ...
        var wrapView = this.props.direction === 'vertical' ? null : 'warp_row';
        return _react2["default"].createElement(
            _reactNative.View,
            { style: _style2["default"][wrapView], onLayout: function onLayout(e) {
                    _this2.onLayout(e);
                } },
            _react2["default"].Children.map(children, function (ele, idx) {
                var errorTail = -1;
                if (idx < children.length - 1) {
                    var status = _this2.props.children[idx + 1].props.status;
                    if (status === 'error') {
                        errorTail = idx;
                    }
                }
