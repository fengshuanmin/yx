...
var StepsItem = function (_React$Component) {
    ...
    StepsItem.prototype.render = function render() {
        ...
        var errorTail = _props.errorTail;
        ...
        return _react2["default"].createElement(
            ...
            _react2["default"].createElement(
                ...
                _react2["default"].createElement(
                    _reactNative.View,
                    { style: [_style2["default"]['head_default' + sizeCls], _style2["default"][headCls]] },
                    _react2["default"].createElement(_reactNative.Image, { source: iconSource, style: _style2["default"]['icon' + sizeCls] })
                ),
                _react2["default"].createElement(_reactNative.View, { style: [_style2["default"]['tail_default' + sizeCls], _style2["default"][tailTopCls]] }),
                _react2["default"].createElement(_reactNative.View, { style: [_style2["default"]['tail_default' + sizeCls], _style2["default"][tailBottomCls]] })
            ),
            _react2["default"].createElement(
                _reactNative.View,
                { style: _style2["default"]['content' + sizeCls] },
                _react2["default"].createElement(
                    _reactNative.Text,
                    { style: [_style2["default"]['title' + sizeCls]] },
                    title
                ),
                _react2["default"].createElement(
                    _reactNative.Text,
                    { style: [_style2["default"]['description' + sizeCls]] },
                    description
                )
            )
        );
