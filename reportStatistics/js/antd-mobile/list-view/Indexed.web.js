...
var MIndexedList = function (_React$Component) {
    ...
    MIndexedList.prototype.render = function render() {
        ...
        var restProps = _handleProps.restProps;
        var extraProps = _handleProps.extraProps;

        return _react2["default"].createElement(
            IndexedList,
            (0, _extends3["default"])({ sectionHeaderClassName: 'am-indexed-list-section-header am-list-body', sectionBodyClassName: 'am-indexed-list-section-body am-list-body' }, restProps, extraProps),
            this.props.children
        );
    };
