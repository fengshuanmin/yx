...
//        ];
//        if (nextProps.dw == "1"){
//            option.series[0].itemStyle.normal.label.formatter="{b}：{c}辆";
//            option.series[0].data[0].value=allData.txCount;
//            option.series[0].data[1].value=allData.jcCount;
//            option.series[0].data[2].value=allData.gsCount;
//        }
//        else if(nextProps.dw == "2")
//        {
//            option.series[0].itemStyle.normal.label.formatter="{b}：{c}元";
//            option.series[0].data[0].value=allData.txMoney;
//            option.series[0].data[1].value=allData.jcMoney;
//            option.series[0].data[2].value=allData.gsMoney;
//            option.series[0].data[0].name="推修金额";
//            option.series[0].data[1].name="接车金额";
//            option.series[0].data[2].name="估损金额";
//        }
...
const ProportionPie = React.createClass({
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.dat != "") {
            ...
            option.legend.data =['完成','未完成',"完成金额","未完成金额"];
            option.series[0].data = [
                {value:"0", name:"未完成"},
                {value:"0", name:'完成'}
            ];
