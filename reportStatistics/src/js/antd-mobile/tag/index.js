    ...
    Modal.prototype.render = function render() {
        ...
        return !this.state.closed ? _react2["default"].createElement(
            ...
            _react2["default"].createElement(
                ...
                _react2["default"].createElement(
                    _reactNative.View,
                    { style: [_index2["default"].wrap, sizeWrapStyle, wrapStyle] },
                    _react2["default"].createElement(
                        _reactNative.Text,
                        { style: [_index2["default"].text, sizeTextStyle, textStyle] },
                        children,
                        ' '
                    )
                )
            ...
            closable && !small && !disabled && _react2["default"].createElement(
                ...
                _react2["default"].createElement(
                    ...
                    _react2["default"].createElement(
                        _reactNative.Text,
                        { style: [_index2["default"].closeText, _reactNative.Platform.OS === 'android' ? _index2["default"].closeTransform : {}] },
                        '\xD7'
                    )
                )
            )
