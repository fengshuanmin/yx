...
var ImagePicker = function (_React$Component) {
    ...
    ImagePicker.prototype.addImage = function addImage(imageObj) {
        if (!imageObj.url) {
            imageObj.url = imageObj.uri;
            delete imageObj.uri;
        }
        var newImages = this.props.files.concat(imageObj);
        this.props.onChange(newImages, 'add');
    };

    ImagePicker.prototype.removeImage = function removeImage(idx) {
        var newImages = [];
        this.props.files.forEach(function (image, index) {
            if (index !== idx) {
    ...
    ImagePicker.prototype.render = function render() {
        ...
        return _react2["default"].createElement(
            ...
            this.state.visible ? _react2["default"].createElement(_ImageRoll2["default"], { onCancel: this.hideImageRoll, onSelected: function onSelected(imgObj) {
