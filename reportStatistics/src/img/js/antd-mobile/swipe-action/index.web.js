...
var SwipeAction = function (_React$Component) {
    ...
    SwipeAction.prototype.renderAndroid = function renderAndroid() {
        ...
        return _react2["default"].createElement(
            ...
            this.state.showModal ? _react2["default"].createElement(_modal2["default"], { animated: false, title: title, transparent: true, closable: false, maskClosable: true, footer: actions, visible: true }) : null
        );
    };
    ...
    SwipeAction.prototype.render = function render() {
        ...
        return left.length || right.length ? _react2["default"].createElement(
            'div',
            { className: wrapClass },
            isAndroid ? this.renderAndroid() : _react2["default"].createElement(
