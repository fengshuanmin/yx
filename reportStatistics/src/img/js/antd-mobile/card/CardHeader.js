...
var CardHeader = function (_React$Component) {
    ...
    CardHeader.prototype.render = function render() {
        ...
        var titleDom = _react2["default"].isValidElement(title) ? _react2["default"].createElement(
            ...
            _reactNative.Text,
            { style: _index2["default"].headerContent },
            title
        );
        var extraDom = _react2["default"].isValidElement(extra) ? _react2["default"].createElement(
            ...
            _reactNative.Text,
            { style: [_index2["default"].headerExtra] },
            extra
        );
        return _react2["default"].createElement(
            _reactNative.View,
            { style: [_index2["default"].headerWrap, style] },
            _react2["default"].createElement(
                _reactNative.View,
                { style: [_index2["default"].headerTitle] },
                thumb ? _react2["default"].createElement(_reactNative.Image, { source: { uri: thumb }, style: [_index2["default"].headerImage, thumbStyle] }) : null,
                titleDom
            ),
            extra ? extraDom : null
        );
