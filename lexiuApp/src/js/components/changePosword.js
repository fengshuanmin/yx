                ...
                <div className="CPBody caseBox">
                    <ul>
                        <li>
                            ...
                            <p className="err">{this.state.errState.oldPassword}</p>
                        </li>
                        <li>
                            ...
                            {this.state.errState.newPassword ? <p className="err">{this.state.errState.newPassword}</p> : <p className="errTS">请输入6-20位字符（不得位纯数字或英文字母</p>}
                        </li>
                        <li>
