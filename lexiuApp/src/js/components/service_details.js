...
const Service_details = React.createClass({
	serviceDatailClick(){
		var detailsData = this.props.location.state;
		this.props.history.replaceState(detailsData, "/service_detail")
	},
    render() {
			...
			<div className="item_details_single" style={{margin:'0rem',padding:'0rem'}}>
				{/*<div className="detailBox">
					...
					<div className="headerInfo">
						<IconFont name="&#xe609;" onClick={this.serviceDatailClick}/>
		  	  ...
		  	  <div className="detailsDiv">
	    		  	...
	    		  	<div className="detailsDiv2">接车时间：
	    		  		<span className="rightSpan">{data.inRepairTimeString}</span>
	    		  	</div>
		  	  ...
		  	  <div className="detailsDiv">
		  	  		...
		  	  		<div className="detailsDiv2">车型名称：
		  	  			<span className="rightSpan">{data.cxmc}</span>
		  	  		</div>
