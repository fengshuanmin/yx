...
export default class Login extends React.Component {
    constructor(props) {
        ...
        this.YZM=()=>{
            ...
            if(this.refs['phone'].value==''){
                ...
                this.props.ajax({
                    ...
                    data:{mobilePhone:this.refs['phone'].value,vertifyType:'1'},
                    suc:(data)=>{
                        console.log(data)
                ...
                this.props.ajax({
                    url:'/toumingxiu/personalRegister/sendVerificationCode.do',
                    data:{mobilePhone:this.refs['phone'].value},
                    suc:(data)=>{
                        console.log(data)
                    }
                })*/
        ...
        this.loginSubmit=(e)=> {
            this.props.ajax({
                url:'/toumingxiu/personalRegister/modifyPwByVerificationCode.do',
                data:{
                ...
                <div className="loginBox">
                    <ul>
                        ...
                        <li style={{borderBottom: '1px solid #dedede'}}>
                            ...
                            <input className="yzlab" style={{flex:'1'}} onBlur={this.blur} ref="yzm" placeholder="请输入验证码" type="text" name="yzm"/>
