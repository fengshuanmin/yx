...
export default class Info extends React.Component {
    ...
    render(){
       ...
       /* console.log(this.state.xlc.finishPayTime==null)
        ...
        return(
            <div>
                {this.state.lingjian!=''&&<div style={{marginBottom:'0.8rem'}}>
                    ...
                    {this.state.loading?<div>
                        <div style={{background:'#fff'}}>
                            <ul style={{background:'#fff',display:'flex',padding:'0.2rem',alignItems:'center'}}>
                                ...
                                <li style={{flex:'1',lineHeight:'0.4rem'}}>
                                    {/*<p><span style={{display:'block',fontSize:'0.3rem',fontWeight:'600'}}>{this.state.xlc.receiverAddr||this.state.xlcname.receiverAddr}</span></p>*/}
                        ...
                        <div style={{marginTop:'0.3rem',background:'#fff'}}>
                            ...
                            <p style={{padding:'0.3rem',borderTop:'0.01rem solid #F4F8FB'}}><span style={{display:'inline-block',marginLeft:'5rem'}}>{this.props.location.state.orderStatus=='101'?'实付款 :':'需付款 :'}</span><span style={{color:'red'}}> ￥{this.state.xlc.totalPrice}</span></p>
                        </div>
                        <div style={{background:'#fff',marginTop:'0.3rem'}}>
                            ...
                            <ul style={{borderBottom:'0.01rem solid #ddd',padding:'0.1rem 0'}}>
                                <li style={{padding:'0.1rem 0.2rem'}}>支付方式 ：<span style={{display:'inline-block',color:'#5B5B5B'}}>{this.state.xlc.source=='XLCDF'?'二维码支付':(this.state.xlc.settleMethod=='WEIXIN'?'微信支付':'支付宝支付')}</span></li>
