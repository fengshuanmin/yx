        ...
        return (
            <div className="changePassword">
                <ul>
                    <li>
                        <span>初始密码:</span>
                        <input type="text" onBlur={this.blur} name="oldPassword" onChange={this.dataState} />
                    </li>
                    <li>
                        <span>新密码:</span>
                        <input type="password" onBlur={this.blur} name="newPassword" onChange={this.dataState}/>
                    </li>
                    <li>
                        <span>再次输入新密码:</span>
                        <input type="password" onBlur={this.blur} name="confirmNewPassword" onChange={this.dataState} onblur={this.check} />
                    </li>
                </ul>
