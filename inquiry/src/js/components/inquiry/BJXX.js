    ...
    constructor(props) {
        ...
        this.yb=(item,index,e)=>{
            ...
            this.props.history.pushState(
                {partId:partid,taskId:this.props.location.state.taskId,fact_part_name:item.fact_part_name}
                ,'/inquiry/accessories')
        }
        this.submit=()=>{
            var text='',array=[]
            console.log(this.state.EQPs)
            /*for(var i in this.state.EQPs){
                for(var j in this.state.EQPs[i].enquiryPatrs){
                    if(this.state.EQPs[i].enquiryPatrs[j].partId){
                        console.log(this.state.EQPs[i].enquiryParts[j].partId)
                        array.push(this.state.EQPs[i].enquiryParts[j].partId)
                    }
                }
            }*/
            if(!this.props.BJXX){
