            ...
            if(nowPropsState.isFromInfo=='yes'){
                ...
                this.props.ajax({
                    ...
                    suc:(dat)=>{
                        if(dat.success){
                            // window.history.go(-1)
                            this.props.history.replaceState({imgList:this.props.location.state.imgList},'/inquiry/addInquiry')
                        }else{
                ...
                if (this.state.AlreadyChosen) {
                    ...
                    if (datArr.length < 1) {
                        ...
                        /*if(this.props.location.state && this.props.location.state.infoflag=='1'){
                            this.props.history.pushState({ListArr:this.state.ListArr||[],
                                taskId:this.props.location.state.taskId},'/inquiry/newinquiry')
                        }else{
                            window.history.go(-1)
                        }*/
                        window.history.go(-1)
            ...
            <div onClick={this.closeDocument} className="SelectionPartsBox">
...

                {
                    this.state.selectData ?
                        ...
                        :
                        this.state.loading ?<div className="SelectionParts">
                            <div className="left">
